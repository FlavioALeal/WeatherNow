...
3. Certifique-se que voce está na pasta **WeatherNow** (caso você tenha clonado o projeto) ou na pasta **WeatherNow-master** (caso você tenha feito o download do proejto)
